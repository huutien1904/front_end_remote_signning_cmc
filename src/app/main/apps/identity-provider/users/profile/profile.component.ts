...
export class ProfileComponent implements OnInit {
  ...
  onSubmitCreateProvince(type,provinceName){
    switch (type) {
      case 1: {
        const countryId = this.formInfoEdit.get('countryResidencePlace').value;
        const body = {
        ...
        this._addressService.createProvince(body).subscribe((res) => {
          ...
          if (
            this.formInfoEdit.get('countryResidencePlace').value != null &&
            countryId == this.formInfoEdit.get('countryResidencePlace').value
          ) {
      ...
      case 2: {
        const countryId = this.formInfoEdit.get('countryBirthPlace').value;
        const body = {
          provinceName: provinceName,
          provinceType: 'Tỉnh/Thành phố',
          countryId: countryId,
  ...
  onSubmitCreateDistrict(type,districtName) {
    switch (type) {
      case 1: {
        const provinceId = this.formInfoEdit.get('provinceResidencePlace').value;
        const body = {
        ...
        this._addressService.createDistrict(body).subscribe((res) => {
          ...
          if (
            this.formInfoEdit.get('provinceBirthPlace').value != null &&
            provinceId == this.formInfoEdit.get('provinceBirthPlace').value
          ) {
      ...
      case 2: {
        const provinceId = this.formInfoEdit.get('provinceBirthPlace').value;
        const body = {
          districtName: districtName,
          districtType: 'Quận/Huyện',
          provinceId: provinceId,
        ...
        this._addressService.createDistrict(body).subscribe((res) => {
          ...
          this.districtResidencePlace = [...this.districtResidencePlace, res.data];
          if (
            this.formInfoEdit.get('provinceResidencePlace').value != null &&
            provinceId == this.formInfoEdit.get('provinceResidencePlace').value
          ) {
  ...
  onSubmitCreateCommune(type,communeName){
    switch (type) {
      case 1: {
        const districtId = this.formInfoEdit.get('districtResidencePlace').value;
        const body = {
        ...
        this._addressService.createCommune(body).subscribe((res) => {
          ...
          if (
            this.formInfoEdit.get('districtBirthPlace').value != null &&
            districtId == this.formInfoEdit.get('districtBirthPlace').value
          ) {
      ...
      case 2: {
        const districtId = this.formInfoEdit.get('districtBirthPlace').value;
        const body = {
          communeName: communeName,
          communeType: 'Xã/Phường',
          districtId: districtId,
        ...
        this._addressService.createCommune(body).subscribe((res) => {
          ...
          this.communeResidencePlace = [...this.communeResidencePlace, res.data];
          if (
            this.formInfoEdit.get('districtResidencePlace').value != null &&
            districtId == this.formInfoEdit.get('districtResidencePlace').value
          ) {
